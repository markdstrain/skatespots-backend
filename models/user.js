  ...
  /** store the Refresh Token in the database */
    ...
    static async register({ username, password, firstName, lastName, email, isAdmin }) {
        ...
        if (duplicateCheck.rows[0]){
            throw new BadRequestError(`username: ${username}, is already being used. Sorry! `);
        }
     ...
     * 
     * This is a "partial update" -- it's fine if datat doesn't contain
     ...
     * Callers of this function must be certain they have valoidated inputs to this
